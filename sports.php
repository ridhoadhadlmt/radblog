...
<div class="container-fluid col-md-10" >
 <div class="ins-sports-post mt-5">
   <div class="row">
    <?php
    $sql = "SELECT * FROM posts WHERE category_post = 'sports' ORDER BY id_post DESC LIMIT 1";
    ...
    <?php
     $sql2 = "SELECT * FROM posts WHERE category_post = 'sports' ORDER BY id_post LIMIT 2,5";
...
<div class="container-fluid col-md-10" id="more-post">
 <?php
 $sql3 = "SELECT * FROM posts WHERE category_post = 'sports' ORDER BY id_post DESC LIMIT 2,3";
...
.ins-sports-post .col-md-8{
    
}
.ins-sports-post .col-md-8 img{
    width: 100%;
    position : relative;
    height: 500px;
}
.ins-sports-post .col-md-8 .newPostInfo{
    position: absolute;
    bottom: 0;
    right: 15px;
    width: 67%;
...
.ins-sports-post .col-md-8 .newPostInfo #title-post{
    color: #000;
}
.ins-sports-post .col-md-8 .newPostInfo a{
    font-size: 28px;
    text-decoration: none;
}
.ins-sports-post .col-md-8 .newPostInfo #title-post:hover{
    color: #0065D5;
    transition: .5s;
}
.ins-sports-post .col-md-8 .newPostInfo #date-post{
    font-size: 14px;
}

.ins-sports-post .col-md-4{
    
} 
.ins-sports-post .col-md-4 #ins-post-left{
    
}
.ins-sports-post .col-md-4 #ins-post-left img{
    width: 100%;
    height: 80px;
}

.ins-sports-post .col-md-4 #ins-post-right #title-post{
   
    color: #000;
    text-decoration: none;
}
.ins-sports-post .col-md-4 #ins-post-right #title-post:hover{
    color: #0065D5;
    transition: .5s;
}
#more-post{
